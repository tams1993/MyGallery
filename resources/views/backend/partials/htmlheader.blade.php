<head>
    ...
    <script src="{{url('plugins/uikit/js/components/slider.min.js')}}"></script>
    <script src="{{url('plugins/uikit/js/components/slideset.min.js')}}"></script>
    <script src="{{url('plugins/uikit/js/components/upload.min.js')}}"></script>
